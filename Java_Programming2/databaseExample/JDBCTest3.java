...
public class JDBCTest3 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			stmt.executeUpdate("insert into student values(1111, '임종호', 'Art', 92, 2)");
			stmt.executeUpdate("insert into student values(2222, '김준섭', 'Math', 100, 1)");
			stmt.executeUpdate("insert into student values(3333, '장지웅', 'Science', 70, 3)");
